...
Taken together, this is exactly what we want to see: BDB should dynamically adapt to the data and borrow less when the historical data are inconsistent with the current data. 
